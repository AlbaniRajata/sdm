...
class EditKegiatanNonJTIPage extends StatefulWidget {
  final Map<String, String> kegiatan;

  const EditKegiatanNonJTIPage({super.key, required this.kegiatan});

  @override
  EditKegiatanNonJTIPageState createState() => EditKegiatanNonJTIPageState();
}

class EditKegiatanNonJTIPageState extends State<EditKegiatanNonJTIPage> {
  ...
  void initState() {
    ...
    _tanggalAcaraController = TextEditingController(text: widget.kegiatan['tanggal_acara']);
    _tanggalSelesaiController = TextEditingController(text: widget.kegiatan['tanggal_selesai']);
    _ketuaController = TextEditingController(text: 'Albani Rajata Malik');
    _jenisController = TextEditingController(text: 'Non JTI');
  }
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDetailField('Jenis Kegiatan', _jenisController, readOnly: true),
  ...
  Widget _buildDetailField(String title, TextEditingController controller, {bool isDescription = false, bool readOnly = false, Color titleColor = Colors.black}) {
    return Padding(
