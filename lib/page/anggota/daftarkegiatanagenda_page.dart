...
class DaftarKegiatanAgendaPageState extends State<DaftarKegiatanAgendaPage> {
  ...
  Future<void> _loadKegiatan() async {
    try {
      ...
      final data = await _apiKegiatan.getKegiatanAnggotaList();
      setState(() {
        kegiatanList = data;
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    children: filteredKegiatanList.map((kegiatan) {
                      return Column(
                        children: [
                          _buildKegiatanCard(context, kegiatan, screenWidth),
  ...
  Widget _buildKegiatanCard(BuildContext context, KegiatanModel kegiatan, double screenWidth) {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      _formatDate(kegiatan.tanggalAcara),
                      style: GoogleFonts.poppins(
                        fontSize: fontSize,
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DetailKegiatanAgendaPage(idKegiatan: kegiatan.idKegiatan),
                          ),
                        );
                      },
                      child: Text(
